"""
This module create the pipeline for building, training and saving ML model.

It includes the process of data preparation, model training using
RandomForestRegressor, hyperparameters tuning  with GridSearchCV,
...
def _get_x_y(
    ...
    """
    logger.info(f"Defining X and y variable. X vars: {col_x} Y var: {col_y}")
...
def _split_train_test(
    ...
    logger.info("Spliting data into train and test sets")
...
def _train_model(
    ...
    logger.info("train the model with hyperparameters")
